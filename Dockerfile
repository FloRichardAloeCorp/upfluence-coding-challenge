...
RUN go build -a -mod=vendor -ldflags '-linkmode external -w -s -extldflags "-static"' -o ./upfluence-coding-challenge
...
COPY --chown=1000:1000 --from=builder /go/src/back/upfluence-coding-challenge upfluence-coding-challenge
